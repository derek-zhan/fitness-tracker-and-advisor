  ...
  try {
    ...
    if (payload.action === "start") {
      ...
      if (activeSession) {
        ...
        const previousSets = activeSession.workoutDay <= 100 && activeSession.sheetTab
      ...
      return Response.json({ sessionId, sheetTab, previousSets:workoutWeek?.previousSets || [] }, { status:201 });
    }
